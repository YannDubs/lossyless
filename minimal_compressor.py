...
print("Downloading data and CLIP")
...
trainer = pytorch_lightning.Trainer(
    gpus=gpus, precision=precision, max_epochs=10, logger=False
)
...
# Download and entropy code evaluation data. Rate: 1703.6 bits, Compression: 230.2 img/sec
print("Download evaluation data and entropy code it.")
