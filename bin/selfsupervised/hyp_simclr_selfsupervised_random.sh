...
experiment=$prfx"hyp_simclr_selfsupervised_random"
notes=""
...
hypopt=optuna
hydra.sweeper.optuna_config.n_trials=100
hydra.sweeper.optuna_config.n_jobs=100
...
seed=0,1,2,3,4
"
# adding seed is to make sure that different initialization (it's fine if you treat it as hyperparameter if you do in all models)
