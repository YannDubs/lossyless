...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in    "featurizer=simclrmini encoder.z_dim=128 trainer.max_epochs=1" #"featurizer=bottlenecksimclr featurizer.loss.beta=0.000001,0.00001,0.0001,0.001,0.01,0.1,1,"
  do
