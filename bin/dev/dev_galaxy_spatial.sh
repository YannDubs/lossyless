...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in "architecture@encoder=balle distortion.kwargs.arch=balle +distortion.kwargs.arch_kwargs.norm_layer=identity " #"architecture@encoder=balle distortion.kwargs.arch=balle"
  do
