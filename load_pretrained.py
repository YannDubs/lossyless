...
class PretrainedAnalyser(PostPlotter):
    ...
    def plot_using_callback(
        self, Callback, is_featurizer=True, plot_config_kwargs={}, **kwargs
    ):
    ...
    def latent_traversals_plot(self, **kwargs):
        ...
        """
        self.plot_using_callback(LatentDimInterpolator, is_featurizer=True, **kwargs)

    def reconstruct_image_plot(self, **kwargs):
