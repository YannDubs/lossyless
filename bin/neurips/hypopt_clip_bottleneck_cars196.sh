...
experiment="hypopt_clip_bottleneck_cars196"
notes="
...
distortion.factor_beta=tag(log,interval(5e-3,3e-2))
...
optimizer_coder.kwargs.weight_decay=tag(log,interval(1e-6,5e-6))
optimizer_coder.kwargs.lr=3e-4
scheduler@scheduler_feat=expdecay1000,expdecay100
