...
experiment="hyp_mlpclip_text_stl10_new"
notes="
...
kwargs_multi="
$kwargs_hypopt
featurizer.loss.beta=tag(log,interval(1e-3,1e-2))
distortion.factor_beta=tag(log,interval(1e-3,1e-2))
