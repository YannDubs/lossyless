...
experiment="STL10_action_distribution_shift"
notes="
**Goal**: Action distribution shift with iVAE/VAE, predicted on features with MLP, ca. 50 runs for each config
"
...
rate=H_hyper
+data_feat.kwargs.dataset_kwargs.p_augment=0.5
"
...
hypopt=optuna
hydra.sweeper.n_trials=500
hydra.sweeper.n_jobs=500
...
+data_pred.kwargs.dataset_kwargs.p_augment=0.05,0.2,0.5,0.7,1.0
"
...
python aggregate.py \
       ...
       collect_data.params_to_add.p_augment=data_pred.kwargs.dataset_kwargs.p_augment
...
python aggregate.py \
       ...
       +plot_pareto_front.hue='p_augment' \
