...
experiment="hyp_optimcoder_augmnist"
notes="
**Goal**: Tuning learning rate / scheduler / optimizer of the coder for ivae on augmented mnist
"
...
kwargs_multi="
optimizer@optimizer_coder=wadam1e-2,wadam3e-3,adam3e-3,sgd
scheduler@scheduler_coder=expdecay,plateau_quick,plateau
" 
