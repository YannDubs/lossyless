...
experiment="imagenet_simclr_workshop_miniwarmup"
notes="
...
featurizer.loss.beta=0.00000001,0.0000001,0.000001,0.00001,0.0001,0.001,0.01
featurizer.skip_first_k_epoch=1
" 
